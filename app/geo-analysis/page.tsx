...
//       <section className="relative bg-gradient-to-r from-blue-500 via-purple-500 to-purple-600 text-white pt-32 pb-24 overflow-hidden">
//         {/* Background decoration */}
//         <div className="absolute inset-0 overflow-hidden">
//           <div className="absolute -top-1/2 -right-1/4 w-96 h-96 bg-purple-400/20 rounded-full blur-3xl"></div>
//           <div className="absolute -bottom-1/2 -left-1/4 w-96 h-96 bg-blue-400/20 rounded-full blur-3xl"></div>
//         </div>
...
//               <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full text-sm font-medium mb-6 border border-white/30 text-white">
//                 <BarChart3 className="w-4 h-4" />
//                 GEO Analysis Platform
//               </div>
              
//               <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold bricolage mb-6 leading-[1.1] text-white">
//                 Find out what AI says about your brand
//               </h1>
              
//               <p className="text-xl md:text-2xl text-white/90 mb-10 leading-relaxed">
//                 Monitor source mentions, track citation patterns, and optimize your content for ChatGPT, Perplexity, Gemini, and other AI platforms.
//               </p>
              
//               {/* CTA Buttons */}
//               <div className="flex flex-wrap gap-4">
//                 <button className="group relative inline-flex items-center gap-2 bg-white text-blue-600 hover:bg-gray-50 px-8 py-4 rounded-xl font-semibold text-lg transition-all shadow-lg hover:shadow-xl hover:scale-[1.02] active:scale-[0.98]">
//                   <span>Start free trial</span>
//                   <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
//                 </button>
                
//                 <button className="inline-flex items-center gap-2 px-8 py-4 bg-white/10 backdrop-blur-sm hover:bg-white/20 rounded-xl font-semibold text-lg transition-all border border-white/30 text-white shadow-md hover:shadow-lg">
...
//                 {/* Glow effect */}
//                 <div className="absolute inset-0 bg-gradient-to-br from-blue-400/30 to-purple-400/30 blur-3xl rounded-3xl"></div>
                
//                 {/* Dashboard mockup */}
//                 <div className="relative bg-white/10 backdrop-blur-xl rounded-2xl border border-white/20 shadow-2xl overflow-hidden">
//                   {/* Browser chrome */}
//                   <div className="bg-gradient-to-r from-white/10 to-white/5 px-4 py-3 flex items-center gap-2 border-b border-white/10">
//                     <div className="flex gap-1.5">
//                       <div className="w-3 h-3 rounded-full bg-red-400/80"></div>
//                       <div className="w-3 h-3 rounded-full bg-yellow-400/80"></div>
//                       <div className="w-3 h-3 rounded-full bg-green-400/80"></div>
//                     </div>
//                     <div className="flex-1 ml-4 bg-white/10 rounded px-3 py-1 text-xs text-white/70 font-mono border border-white/20">
//                       visble.ai/dashboard
//                     </div>
//                   </div>
...
//                         <span>Rankings • Comparison with Competitors</span>
//                         <span>Visibility: 4/14 ↑</span>
//                       </div>
                      
//                       {[
//                         { rank: 1, name: 'HubSpot', visibility: 'Visibility', score: '85%' },
//                         { rank: 2, name: 'Attio', visibility: 'Visibility', score: '85%' },
//                         { rank: 3, name: 'Close', visibility: 'Visibility', score: '85%' },
//                         { rank: 4, name: 'Monday', visibility: 'Visibility', score: '80%' },
//                       ].map((item) => (
//                         <div key={item.rank} className="flex items-center gap-3 bg-white/10 backdrop-blur-sm rounded-lg p-3 border border-white/20">
//                           <span className="text-white/70 text-sm w-6">{item.rank}</span>
//                           <div className="flex items-center gap-2 flex-1">
//                             <div className="w-8 h-8 rounded bg-gradient-to-br from-blue-400 to-purple-400"></div>
//                             <span className="text-white font-medium text-sm">{item.name}</span>
//                           </div>
//                           <div className="text-right">
//                             <div className="text-xs text-white/60">{item.visibility}</div>
...
//                           <div key={i} className="flex-1 bg-gradient-to-t from-blue-400 to-purple-400 rounded-t opacity-80 hover:opacity-100 transition-opacity" style={{ height: `${height}%` }}></div>
//                         ))}
//                       </div>
//                     </div>
//                   </div>
...
//               Comprehensive GEO Analytics Dashboard
//             </h2>
//             <p className="text-xl text-gray-600 max-w-2xl mx-auto">
//               Get a complete view of your AI search performance with real-time tracking and actionable insights
//             </p>
//           </div>
...
//                       </defs>
//                       <path
//                         d="M 0 120 L 50 100 L 100 110 L 150 80 L 200 90 L 250 60 L 300 70 L 350 40 L 400 50 L 400 150 L 0 150 Z"
//                         fill="url(#areaGradient)"
//                       />
                      
//                       {/* Line */}
//                       <path
//                         d="M 0 120 L 50 100 L 100 110 L 150 80 L 200 90 L 250 60 L 300 70 L 350 40 L 400 50"
//                         fill="none"
//                         stroke="#8b5cf6"
//                         strokeWidth="3"
//                         strokeLinecap="round"
...
//                           <div
//                             className={`h-full bg-gradient-to-r ${item.color} rounded-full transition-all duration-500 group-hover:opacity-80`}
...
//       {/* Features - Large Scale Experiments */}
...
//               </div>
//               <h2 className="text-4xl font-bold bricolage text-gray-900 mb-6">
//                 Test Thousands of Prompts at Scale
//               </h2>
//               <p className="text-lg text-gray-600 mb-6 leading-relaxed">
//                 Run comprehensive experiments across multiple AI models simultaneously. Test different content variations, track performance patterns, and identify what drives citations.
//               </p>
//               <ul className="space-y-4">
//                 {[
//                   'Test 10,000+ prompts across ChatGPT, Perplexity, Gemini, and Claude',
//                   'A/B test content variations to find optimal formats',
//                   'Track citation patterns and identify winning strategies',
//                   'Automated daily monitoring with trend analysis',
//                 ].map((feature, i) => (
...
//               </div>
//               <h2 className="text-4xl font-bold bricolage text-gray-900 mb-6">
//                 Monitor Your Brand Across Every AI Engine
//               </h2>
//               <p className="text-lg text-gray-600 mb-6 leading-relaxed">
//                 Get real-time visibility into how often your brand appears in AI-generated responses. Track trends, identify opportunities, and benchmark against competitors.
//               </p>
//               <ul className="space-y-4">
//                 {[
//                   'Real-time tracking across 10+ AI search engines',
...
//               </h2>
//               <p className="text-lg text-gray-600 mb-6 leading-relaxed">
//                 Analyze your content structure, identify gaps, and get actionable recommendations to improve citation rates across AI models.
//               </p>
//               <ul className="space-y-4">
//                 {[
//                   'Semantic analysis of content crawlability',
//                   'Entity and topic extraction for better targeting',
//                   'Citation-worthy format recommendations',
...
//               See how businesses use GEO Analysis to dominate AI search
//             </p>
//           </div>
...
//                 company: 'Acredge',
//                 industry: 'EdTech',
//                 result: '100+ Source Mentions',
//                 metric: '850% AI Visibility',
//                 description: 'Went from 0 to 100+ mentions in 60 days using GEO tracking and content optimization.',
//               },
//               {
//                 company: 'Flyhomes',
//                 industry: 'Real Estate',
//                 result: '512% Growth',
//                 metric: 'Top 3 Position',
//                 description: 'Jumped from 17th to 3rd position in AI citations across all major engines.',
//               },
//               {
//                 company: 'DGFT Guru',
//                 industry: 'Compliance',
//                 result: '80% Visibility',
//                 metric: '400% Recovery',
//                 description: 'Recovered from visibility drop and exceeded previous peak performance.',
//               },
//             ].map((study, i) => (
//               <div key={i} className="bg-white rounded-2xl shadow-lg p-8 border border-purple-100 hover:shadow-xl transition-all">
...
//                   <div className="flex-1 bg-gradient-to-br from-blue-50 to-purple-50 rounded-lg p-3 border border-purple-100">
//                     <div className="text-2xl font-bold bricolage text-purple-600">{study.result}</div>
//                   </div>
//                   <div className="flex-1 bg-gradient-to-br from-purple-50 to-pink-50 rounded-lg p-3 border border-purple-100">
//                     <div className="text-2xl font-bold bricolage text-blue-600">{study.metric}</div>
//                   </div>
//                 </div>
//                 <p className="text-gray-600 text-sm leading-relaxed mb-4">{study.description}</p>
//                 <Link href="/case-studies" className="text-purple-600 hover:text-purple-700 font-semibold text-sm flex items-center gap-1">
...
//             <h2 className="text-4xl font-bold bricolage mb-4">
//               Ready to Dominate AI Search?
//             </h2>
//             <p className="text-xl mb-8 opacity-90">
//               Start tracking your brand visibility across AI engines today
//             </p>
...
//           <h2 className="text-4xl font-bold bricolage text-gray-900 mb-12 text-center">
//             Frequently Asked Questions
//           </h2>
//           <div className="space-y-4">
//             {[
//               {
//                 q: 'What AI engines does GEO Analysis track?',
//                 a: 'We track all major generative AI platforms including ChatGPT (GPT-3.5, GPT-4), Perplexity AI, Google Gemini, Claude, Bing Chat, and more. Our coverage expands as new AI search engines emerge.',
//               },
//               {
//                 q: 'How often is the data updated?',
//                 a: 'Our platform runs automated checks daily, with real-time updates available for priority keywords. You can also trigger manual scans at any time to get instant visibility data.',
//               },
//               {
//                 q: 'Can I track competitor mentions?',
//                 a: 'Yes! GEO Analysis includes competitor benchmarking. Track how often competitors are mentioned, compare citation rates, and identify gaps in your content strategy.',
//               },
//               {
//                 q: 'What makes content citation-worthy?',
//                 a: 'AI models prioritize content that is authoritative, well-structured, up-to-date, and directly answers user queries. Our Content Analysis feature identifies exactly what needs improvement in your content.',
//               },
//               {
//                 q: 'How long does it take to see results?',
//                 a: 'Most clients see measurable improvements in 30-60 days. However, the timeline depends on your current domain authority, content quality, and industry competition.',
//               },
//             ].map((faq, i) => (
//               <details key={i} className="bg-white rounded-lg shadow-sm border border-purple-100 p-6 group">
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: 'https://visble.ai/og-geo-analysis.png',
        width: 1200,
        height: 630,
        alt: 'Visble GEO Analytics Dashboard',
      },
    ],
  },
  alternates: {
    canonical: 'https://visble.ai/geo-analysis',
  },
  keywords: [
    'GEO analytics',
