        ...
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <div className="relative">
              ...
              {isToolsOpen && (
                <div className="absolute top-full left-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-100 py-3 z-50">
                  <a href="https://app.visble.ai/login" className="block px-4 py-2 text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-colors">
                    Geo Analysis
                  </a>
                  <a href="https://visble.ai/llms-txt-generator/" className="block px-4 py-2 text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-colors">
                    llms.txt Generator
                  </a>
                  {/* <a href="#ai-insights" className="block px-4 py-2 text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-colors">
                    AI Insights
          ...
          <div className="md:hidden py-4 border-t border-gray-100">
            <nav className="flex flex-col space-y-4">
              ...
              <div className="flex flex-col space-y-2 pt-4">
                ...
                <Button 
                  className="bg-primary hover:bg-primary/90 text-white justify-start"
                  asChild
                >
                  <a href="https://app.visble.ai/signup">
                    Book a Demo
